...
export class AboutMeComponent implements OnInit {
  ...
  EN: {
    ...
    paragraph3: string;
      ...
      title: "About Me",
      paragraph1: "I am an enthusiastic front-end developer and have been interested in information technology since my school days. At the Developer Akademie, I was able to pursue my passion and acquire knowledge in front-end development by developing various projects.",
